...
<div class="container mt-5 bg-white">
    <div class="container mx-auto mt-5">
        <div class=" mx-auto bg-white shadow-lg rounded-lg ">
            <div class="p-7">
                <h1 class="text-2xl font-bold text-gray-800">Rating Project Website Pengaduan Aspirasi Masyarakat</h1>
                <form action="proses_add.php" method="POST">
                    ...
                    <div class="flex items-center text-center mt-2">
                        <input type="hidden" name="nama" value="Website Pengaduan Aspirasi Masyarakat" id="nama">
